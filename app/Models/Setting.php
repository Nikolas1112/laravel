...
class Setting extends BaseModel
{
		...
		if (!empty($value)) {
			...
			if ($this->key == 'app') {
				foreach ($value as $key => $item) {
					...
					if ($key == 'logo_dark') {
						if (!$disk->exists($value['logo_dark'])) {
							$value[$key] = config('larapen.admin.logo_dark');
						}
					}
					
					if ($key == 'logo_light') {
						if (!$disk->exists($value['logo_light'])) {
							$value[$key] = config('larapen.admin.logo_light');
						}
					}
				}
				...
				if (!in_array('logo_dark', array_keys($value))) {
					$value['logo_dark'] = config('larapen.admin.logo_dark');
				}
				if (!in_array('logo_light', array_keys($value))) {
					$value['logo_light'] = config('larapen.admin.logo_light');
				}
	...
	*/
	public function setValueAttribute($value)
	{
		...
		if (isset($value['logo_dark'])) {
			$logoDark = [
				'attribute' => 'logo_dark',
				'path'      => 'app/backend',
				'default'   => config('larapen.admin.logo_dark'),
				'width'     => 600,
				'height'    => 80,
				'ratio'     => '1',
				'upSize'    => '0',
		...
		if (isset($value['logo_light'])) {
			$logoLight = [
				...
				'path'      => 'app/backend',
				'default'   => config('larapen.admin.logo_light'),
				'width'     => 600,
				'height'    => 80,
				'ratio'     => '1',
				'upSize'    => '0',
	...
	{"name":"logo_dark","label":"logo_dark_label","type":"image","upload":"true","disk":"' . $diskName . '","default":"' . config('larapen.admin.logo_dark') . '","hint":"logo_dark_hint","wrapperAttributes":{"class":"form-group col-md-6"}},
	{"name":"logo_light","label":"logo_light_label","type":"image","upload":"true","disk":"' . $diskName . '","default":"' . config('larapen.admin.logo_light') . '","hint":"logo_light_hint","wrapperAttributes":{"class":"form-group col-md-6"}},
	...
	{"name":"img_resize_square_width","label":"img_resize_width_label","type":"number","hint":"img_resize_width_hint","wrapperAttributes":{"class":"form-group col-md-6"}},
	{"name":"img_resize_square_height","label":"img_resize_height_label","type":"number","hint":"img_resize_height_hint","wrapperAttributes":{"class":"form-group col-md-6"}},
