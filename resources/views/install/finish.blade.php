...
@section('content')
    ...
    <h3 class="title-3 text-success">
        <i class="icon-check"></i> Congratulations, you've successfully installed Bunitas (Classified Ads Web Application)
    </h3>
    ...
    <br><br>
    Thank you for chosing Bunitas. - <a class="text-bold" href="http://www.bedigit.com" target="_blank">bedigit.com</a>
