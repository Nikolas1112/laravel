...
<div class="main-wrapper">
    ...
    <div class="auth-wrapper d-flex no-block justify-content-center align-items-center"
         style="background:url({{ imgUrl(config('settings.app.login_bg_image')) }}) no-repeat center center; background-size: cover;"
    >
        <div class="auth-box p-4 bg-white rounded">
    
            <div class="logo text-center mb-5">
                <a href="{{ url('/') }}">
                    <img src="{{ imgUrl(config('settings.app.logo_dark')) }}" alt="logo" class="img-fluid" style="width:250px; height:auto;">
                </a>
                <hr>
            </div>
...
{{-- All Required js --}}
<script src="{{ asset('vendor/admin-theme/plugins/jquery/dist/jquery.min.js') }}"></script>
{{-- Bootstrap tether Core JavaScript --}}
<script src="{{ asset('vendor/admin-theme/plugins/popper.js/dist/umd/popper.min.js') }}"></script>
