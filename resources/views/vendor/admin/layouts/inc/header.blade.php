		...
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="{{ url('/') }}" target="_blank">
				...
				<span class="logo-text">
					<img src="{{ imgUrl(config('settings.app.logo_dark')) }}" alt="{{ strtolower(config('settings.app.app_name')) }}" class="dark-logo img-fluid"/>
					<img src="{{ imgUrl(config('settings.app.logo_light')) }}" alt="{{ strtolower(config('settings.app.app_name')) }}" class="light-logo img-fluid"/>
				</span>
			</a>
